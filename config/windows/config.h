...
#define PACKAGE_STRING "distcc 2.18.3-rv"
...
#ifndef SYSCONFDIR
#define SYSCONFDIR "c:/cygwin/etc"
#endif
...
extern CRITICAL_SECTION log_crit_sec;

#define LOCK(name)		EnterCriticalSection(&name##_crit_sec)
#define UNLOCK(name)	LeaveCriticalSection(&name##_crit_sec)
