...
#ifndef _rvfc_net_interface_
#define _rvfc_net_interface_
...
public:
	...
	public:
		...
		CLASS_EXCEPTION_DEF("rvfc::NetworkInterface::Addresses::Iterator");
...
public:
	CLASS_EXCEPTION_DEF("rvfc::NetworkInterfaces");
	CLASS_SUB_EXCEPTION_DEF(QueryErr, "query error");
};
