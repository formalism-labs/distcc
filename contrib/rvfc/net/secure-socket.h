...
#ifndef _rvfc_net_secure_socket_
#define _rvfc_net_secure_socket_

#include "rvfc/classes.h"
#include "rvfc/security/general.h"
#include "rvfc/security/context.h"
#include "rvfc/net/socket.h"
...
public:
	CLASS_EXCEPTION_DEF("rvfc::SecureSocket");
...
#endif // _rvfc_net_secure_socket_
