...
Text::text IPAddress::text() const
{
...
IPv4Address::IPv4Address(const std::string &addr) : IPAddress(addr)
{
	if (family() != AF_INET)
...
IPv4MappedAddress::IPv4MappedAddress(const std::string &addr) : IPAddress(addr)
{
	if (!isV4Mapped())
...
IPv6Address::IPv6Address(const std::string &addr) : IPAddress(addr)
{
	if (family() != AF_INET6)
...
Text::text SocketAddress::text() const
{
