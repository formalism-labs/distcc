...
#ifndef _rvfc_net_basics_
#define _rvfc_net_basics_
...
#ifdef _WIN32
// 'rvfc::NetOrder<T,M>' : assignment operator could not be generated
#pragma warning(push)
...
public:
	...
	CLASS_EXCEPTION_DEF("rvfc::Protocol");
...
public:
	...
	CLASS_EXCEPTION_DEF("rvfc::Service");
