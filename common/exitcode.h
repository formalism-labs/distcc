...
// These need to be in [1,255] so that they can be used as exit() codes.
...
enum dcc_exitcode 
{
    ...
    EXIT_TIMEOUT                  = 118,
    EXIT_NO_COMPILER_SETTING      = 119, // distcc was not able to set a compiler
    EXIT_BAD_FUNCTION_CALL        = 120
};
